...
const OtherAppliancesPage = () => (
  <ServiceLayout 
    ...
    longDesc="From high-performance mixers to precision steam irons, we provide expert repair services for a wide range of small household appliances. Our experts ensure your everyday gear stays in perfect working condition."
    icon={<Boxes size={24} />}
    image="/others.jpg"
    extraContent={
      <div className="space-y-12">
        <section>
          <h2 className="text-3xl font-black text-gray-900 mb-6 uppercase tracking-tight">Small Appliance, Big Impact</h2>
          <p className="text-gray-500 leading-relaxed font-medium">
            We specialize in repairing various household appliances that make your daily life easier. Our specialized team is equipped with the right tools and knowledge to diagnose and fix issues in mixers, grinders, irons, vacuum cleaners, and more.
          </p>
        </section>

        <section className="bg-gray-900 p-10 rounded-[40px] text-white">
          <h3 className="text-2xl font-black text-gray-900 mb-6 uppercase tracking-tight text-white">Precision Professional Care</h3>
        ...
        <section>
          <h3 className="text-2xl font-black text-gray-900 mb-6 uppercase tracking-tight">Precision Professional Care</h3>
